...
SECRET_KEY = 'django-insecure-hj3(do3em6g#_%h3ezwmiupnmpz+)1pl^^6uan31nqw!i-(+$q'
...
INSTALLED_APPS = [
    ...
    'api_view_hestia', # Añadido para la aplicación 
    'rest_framework', # Añadido para DRF
...
EMAIL_USE_TLS = True
EMAIL_USE_SSL = False
EMAIL_HOST_USER = 'a40549001@smtp-brevo.com'
EMAIL_HOST_PASSWORD = 'bskMWnhDQaUxEsc'
DEFAULT_FROM_EMAIL = 'HESTIA <armoniashio@gmail.com>'
EMAIL_TIMEOUT = 30
